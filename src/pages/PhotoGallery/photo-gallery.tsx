  ...
  return (
    <div className="p-4" style={{ animation: 'fadeIn 0.5s ease-in-out' }}>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h3 className="fw-bold text-dark mb-1">Photo Gallery</h3>
          <p className="text-muted">Manage all registered photos for the foundation.</p>
        </div>
        <div>
          <Button
            type="primary"
      ...
      <div className="card border-0 shadow-sm">
        <div className="card-body p-0">
          <div className="p-3 border-bottom d-flex justify-content-between align-items-center bg-light ">
            <h5 className="m-0 fw-bold text-muted">Registered Photos List</h5>
            <div style={{ width: 300 }}>
              <Input
                size="large"
