    ...
    if (!data) {
        return (
            <div className="d-flex flex-column justify-content-center align-items-center" style={{ minHeight: '60vh' }}>
                <h4 className="text-muted mb-4">Photo not found</h4>
                <Button type="primary" onClick={() => navigate('/photo-gallery')}>Back to Gallery</Button>
            </div>
        );
    }
        ...
        >
            <div className="container-fluid py-4">
                <div className="d-flex justify-content-between align-items-center mb-4">
                    <h2 className="mb-0 page-title" style={{ fontFamily: 'Poppins', fontWeight: 600 }}>Photo Details</h2>
                    <Button onClick={() => navigate('/photo-gallery')} icon={<i className="bi bi-arrow-left"></i>} size="large">
                        Back to Gallery
                    </Button>
                </div>
