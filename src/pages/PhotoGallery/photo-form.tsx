...
import { Card, Button, Progress, message, Input } from 'antd';
...
export default function PhotoForm() {
    ...
    // [ANGULAR CONCEPT]: These represent our form model.
    ...
    return (
        <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '80vh', backgroundColor: '#f0f2f5' }}>
            <Card
