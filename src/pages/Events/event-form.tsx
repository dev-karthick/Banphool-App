...
export default function EventForm() {
    ...
    const submitAllFiles = async () => {
        ...
        try {
            ...
            const response = await EventService.uploadEvent({
        ...
        <div className="d-flex justify-content-center align-items-center mt-5">
            ...
            >
                ...
                <div className="d-flex justify-content-between align-items-center mb-1">
                    ...
                    <Button type="text" icon={<i className="bi bi-x-lg"></i>} onClick={() => navigate('/events')} />
                </div>
                ...
                <div className="mt-1">
                    <Form
                        ...
                        <div className='col-md-12'>
                            <Form.Item label={<span className='fs-6 fw-semibold' style={{ fontFamily: 'Poppins' }}>Enter Event Header</span>} name="header"
                                rules={
                                    [
                                        {
                                            required: true,
                                            message: 'Please enter the event header!'
                                        }
                                    ]
                                }>
                                <Input
                ...
                <div className="d-flex gap-3 mt-4">
                    <Button size="large" className="flex-fill fw-semibold rounded-3" onClick={() => navigate('/events')}>
                        Cancel
                    </Button>
                    <Button
                        type="primary"
